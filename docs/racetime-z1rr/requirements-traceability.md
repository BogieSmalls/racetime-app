...
| Requirement | Plan/task | Artifacts | Primary automated verification | Gate | Status |
| --- | --- | --- | --- | --- | --- |
| FR-LS-001 side-by-side identity | LiveSplit Tasks 2, 7–8; Operations Task 8 | LS-002, LS-006, LS-008 | reflection/load/settings/credential collision smoke and post-issuance fresh-production side-by-side evidence | G0/G2 | Planned |
...
| FR-OPS-003 schedule/retention/alert | Platform Task 6; Operations Tasks 4, 7–8 | PLT-008, OPS-005, OPS-007 | timer/retention/freshness plus post-issuance production-Caddy-state restore tests | G0/G2 | Planned |
| FR-OPS-004 RPO/RTO | Operations Tasks 7–8 | OPS-007 | measured fresh-production ARM64/amd64 isolated restore report | G2 | Planned |
...
| FR-OPS-007 empty-host rebuild | Platform Tasks 2, 6, 8; Operations Tasks 3, 7–8 | PLT-001, PLT-005, PLT-006, PLT-008, PLT-010, OPS-002, OPS-006, OPS-007 | same-commit ARM64/amd64 manifest, verified account-level recovery route, dual-architecture load evidence, and fresh-production empty-host amd64 restore/RTO evidence | G2 | Planned |
...
| NFR-SEC-002 network/secrets and sealed recovery custody | Platform Tasks 1, 3, 8; Operations Tasks 3, 5, 7, 9 | PLT-002, PLT-004, PLT-006, PLT-010 | Compose/IaC/port/secret scans plus primary-access, account-recovery-route, and sealed-package version/fingerprint/custody validation | G0/G1/G2/G3 | Planned |
...
| NFR-REL-002 Redis non-authority | Core Task 5A; Operations Tasks 6–8 | APP-005, APP-011, OPS-008 | Redis-loss route matrix plus qualification and post-issuance race lifecycle evidence | G2 | Planned |
...
| Break-glass, sealed recovery custody, and account-level recovery §9.4 | Core Task 5; Platform Task 4; Operations Tasks 3, 5–7 |
| Branding/policies §9.6 | Core Task 10; APP-009 |
| Qualification/fresh-production/build/release §13 | Master Tasks 5–9; Platform Tasks 2–4, 6–7, 10; Operations Tasks 4–10 |
